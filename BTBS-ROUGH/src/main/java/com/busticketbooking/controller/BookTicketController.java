...
public class BookTicketController {
	...
	/**
	 * get the booking details by customer and bus id for updating booking status
	 * 
	 * @param id
	 * @param bid
	 * @param cid
	...
	/**
	 * get the booking details by customer and bus id for rejecting booking status
	 * 
	 * @param id
	 * @param bid
	 * @param cid
	...
	public ResponseEntity<HttpResponseStatus> reject(@PathVariable long id) {

		logger.info("Entering Booking Ticket delete bookings by Booking id function");

		try {
			message = bookTicketService.deleteBookTicket(id);
	...
	@GetMapping("/bus/{id}")
	public ResponseEntity<HttpResponseStatus> getbyBusid(@PathVariable Long id) {
		logger.info("Entering Booking Ticket Get bookings by Customer Id function");

		try {
			List<BookTicket> bookTicket = bookTicketService.getTicketByBusId(id);
			return new ResponseEntity<HttpResponseStatus>(
					new HttpResponseStatus(HttpStatus.OK.value(), "Data retrieved successfully", bookTicket),
					HttpStatus.OK);
